...
<nav class="navbar navbar-icon-top navbar-expand-lg navbar-light bg-light" style="margin-bottom: 50px">
    <div class="container-fluid">
        <a class="navbar-brand" href="http://localhost:81/CMS_QT_G/wordpress/">Nhom E</a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link" href="http://localhost:81/CMS_QT_G/wordpress/">
                        Home
            ...
            <ul class="navbar-nav nav_a">
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost:81/CMS_QT_G/wordpress/2023/10/29/chiec-ve-so-may-man/">
                        <!-- <i class="fa fa-solid fa-ellipsis"></i> -->
                        Thể Thao
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost:81/CMS_QT_G/wordpress/2023/10/29/mua-xuan/">
                        <!-- <i class="fa fa-solid fa-ellipsis"></i> -->
                        Khoa Học 
                    </a>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="http://localhost:81/CMS_QT_G/wordpress/search">
